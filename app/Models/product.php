...
class product extends Model
{
    ...
    private $name, $minimumSystemRequirementsId, $recommendedSystemRequirementsId, $display, $developer, $publisher, $releaseDate, $price, $saleName, $saleDisplay, $discount, $image, $backgroundImage, $description;

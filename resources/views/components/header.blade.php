 {{-- include LOCAL_PATH_ROOT . '/game/modal.php'; 
 include LOCAL_PATH_ROOT . '/game/notice.php';  --}}
<div id="header-bar">
    <div class="container">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-md navbar-dark font-weight-bold">
            ...
            <a href="/game/">
                <img src="/game/img/logo.png" width="80" height="80" class="d-inline-block align-top position-absolute" alt="" style="top: -30px; left: 0px">
                <div class="position-absolute text-main" style="top: 32px; left: 3px; background: -webkit-linear-gradient(left, #1d39be, #0bdad0, #745eed, #e900a7);-webkit-background-clip: text; -webkit-text-fill-color: transparent;"> Steam </div>
            </a>
